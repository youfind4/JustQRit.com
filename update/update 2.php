...
$update_key = array_search($product_info ? $product_info->code : PRODUCT_CODE, $updates);
...
foreach($updates_to_run as $value) {
    ...
    if(isset($exploded_dump_content[1]) && in_array($license->type, ['SPECIAL', 'Extended License'])) {
