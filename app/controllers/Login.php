                ...
                if(isset($response)) {
                    ...
                    /* Create a new account */
                        ...
                        if(empty($_SESSION['error'])) {
                            ...
                            $stmt = Database::$database->prepare("INSERT INTO `users` (`password`, `email`, `name`, `api_key`, `facebook_id`, `plan_id`, `plan_expiration_date`, `plan_settings`, `language`, `timezone`, `active`, `date`, `ip`, `country`, `last_user_agent`, `total_logins`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                            $stmt->bind_param('ssssssssssssssss', $password, $email, $name, $api_key, $facebook_user_id, $plan_id, $plan_expiration_date, $plan_settings, Language::$language, $timezone, $active, \Altum\Date::$date, $ip, $country, $user_agent, $total_logins);
                            $stmt->execute();
