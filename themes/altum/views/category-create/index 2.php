    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text" id="url" name="url" class="form-control" value="<?= $data->values['url'] ?>" placeholder="<?= $this->language->category->input->url_placeholder ?>" />
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" value="<?= $data->values['name'] ?>" placeholder="<?= $this->language->category->input->name_placeholder ?>" required="required" />
        </div>
