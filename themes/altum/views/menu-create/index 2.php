    ...
    <nav aria-label="breadcrumb">
        <small>
            <ol class="custom-breadcrumbs">
                ...
                <li class="active" aria-current="page"><?= $this->language->menu_create->breadcrumb ?></li>
            </ol>
        </small>
    </nav>

    <h1 class="h4 text-truncate"><?= $this->language->menu_create->header ?></h1>
    <p></p>
    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text" id="url" name="url" class="form-control" value="<?= $data->values['url'] ?>" placeholder="<?= $this->language->menu->input->url_placeholder ?>" />
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" value="<?= $data->values['name'] ?>" placeholder="<?= $this->language->menu->input->name_placeholder ?>" required="required" />
        </div>
