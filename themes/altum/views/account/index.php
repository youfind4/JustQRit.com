...
<div class="container">
    ...
    <form action="" method="post" role="form">
        ...
        <div class="">
            <h1 class="h4"><?= $this->language->account->settings->header ?></h1>
        ...
        <div class="" id="billing" style="<?= !$this->settings->payment->is_enabled || !$this->settings->payment->taxes_and_billing_is_enabled ? 'display: none;' : null ?>">
        ...
        <div class="">
            <h1 class="h4"><?= $this->language->account->twofa->header ?></h1>
        ...
        <div class="">
            <h1 class="h4"><?= $this->language->account->change_password->header ?></h1>
        ...
        <button type="submit" name="submit" class="btn btn-block btn-primary mt-5"><?= $this->language->global->update ?></button>
    </form>
</div>
