...
<div class="container">
    ...
    <?php else: ?>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
            <img src="<?= SITE_URL . ASSETS_URL_PATH . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-5 mb-3" alt="<?= $this->language->account_payments->payments->no_data ?>" />
            <h2 class="h4 text-muted mt-3"><?= $this->language->account_payments->payments->no_data ?></h2>
        </div>
