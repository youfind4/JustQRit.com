...
<div class="card">
    <div class="card-body">
        <h3 class="h5"><?= $this->language->statistics->statistics->language ?></h3>
        <p class="text-muted mb-3"><?= $this->language->statistics->statistics->language_help ?></p>
                ...
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        <?php if(!$row->browser_language): ?>
                            <span><?= $this->language->statistics->statistics->browser_unknown ?></span>
                        <?php else: ?>
