...
<div class="my-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-store mr-1"></i> <?= $this->language->admin_user_view->stores ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_stores_total) ?></span></div>
            </div>

            <div class="bg-gray-200 px-2 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/stores?email=' . $data->user->email) ?>">
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-list mr-1"></i> <?= $this->language->admin_user_view->menus ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_menus_total) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-shopping-bag mr-1"></i> <?= $this->language->admin_user_view->categories ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_categories_total) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-burn mr-1"></i> <?= $this->language->admin_user_view->items ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_items_total) ?></span></div>
            </div>
        </div>
    </div>
