    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                <label><i class="fa fa-fw fa-globe fa-sm mr-1 text-muted"></i> <?= $this->language->admin_domains->main->host ?></label>
            ...
            <div class="form-group">
                <label><i class="fa fa-fw fa-sitemap fa-sm text-muted mr-1"></i> <?= $this->language->admin_domains->main->custom_index_url ?></label>
            ...
            <div class="form-group">
                <label><i class="fa fa-fw fa-eye fa-sm text-muted mr-1"></i> <?= $this->language->admin_domains->main->is_enabled ?></label>
