...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-chart-line fa-xs text-muted"></i> <?= $this->language->admin_statistics->statistics->header ?></h2>
...
<script>
    ...
    new Chart(statistics_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode($this->language->admin_statistics->statistics->chart) ?>,
