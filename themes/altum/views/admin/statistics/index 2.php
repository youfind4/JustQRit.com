...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills">
            ...
            <?php if(in_array($this->settings->license->type, ['Extended License', 'extended'])): ?>
            ...
            <?php endif ?>
            <a class="nav-link <?= $data->type == 'stores' ? 'active' : null ?>" href="<?= url('admin/statistics/stores?start_date=' . $data->date->start_date . '&end_date=' . $data->date->end_date) ?>"><i class="fa fa-fw fa-sm fa-store mr-1"></i> <?= $this->language->admin_statistics->stores->menu ?></a>
            <a class="nav-link <?= $data->type == 'statistics' ? 'active' : null ?>" href="<?= url('admin/statistics/statistics?start_date=' . $data->date->start_date . '&end_date=' . $data->date->end_date) ?>"><i class="fa fa-fw fa-sm fa-chart-line mr-1"></i> <?= $this->language->admin_statistics->statistics->menu ?></a>
            <a class="nav-link <?= $data->type == 'email_reports' ? 'active' : null ?>" href="<?= url('admin/statistics/email_reports?start_date=' . $data->date->start_date . '&end_date=' . $data->date->end_date) ?>"><i class="fa fa-fw fa-sm fa-envelope mr-1"></i> <?= $this->language->admin_statistics->email_reports->menu ?></a>
        </div>
    </div>
