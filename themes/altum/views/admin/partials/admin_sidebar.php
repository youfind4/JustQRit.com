...
<section class="admin-sidebar">
    ...
    <ul class="admin-sidebar-links">
        ...
        <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminStores']) ? 'active' : null ?>">
            <a class="nav-link d-flex flex-row" href="<?= url('admin/stores') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-store"></i></div>
                <div class="col">
                    <span class="d-inline"><?= $this->language->admin_stores->menu ?></span>
                </div>
            </a>
        </li>
