                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="payment">
                            ...
                            <div class="<?= !in_array($this->settings->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
                                <div class="form-group">
...
<script>
    ...
    initiate_smtp_auth();
    document.querySelector('input[name="smtp_auth"]').addEventListener('change', initiate_smtp_auth);
